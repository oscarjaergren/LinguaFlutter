...
/// Riverpod provider for [StreakNotifier].
///
/// Override [streakServiceProvider] in tests to inject a mock service.
...
///
/// Replaces [StreakProvider]. Loading/error state is part of [StreakState]
/// rather than separate fields — no [ProviderState] boilerplate needed.
