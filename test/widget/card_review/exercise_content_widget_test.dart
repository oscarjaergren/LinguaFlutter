...
void main() {
  ...
  group('ExerciseContentWidget', () {
    ...
    group('Multiple Choice Text', () {
      ...
      testWidgets('should show override buttons after answer checked', (tester) async {
        await tester.pumpWidget(buildTestWidget(
          exerciseType: ExerciseType.multipleChoiceText,
          multipleChoiceOptions: ['Hello', 'World', 'Thanks', 'Goodbye'],
      ...
      testWidgets('should call onOverrideAnswer when Mark Wrong tapped', (tester) async {
        await tester.pumpWidget(buildTestWidget(
          exerciseType: ExerciseType.multipleChoiceText,
          multipleChoiceOptions: ['Hello', 'World', 'Thanks', 'Goodbye'],
          answerState: AnswerState.answered,
      ...
      testWidgets('should call onOverrideAnswer when Mark Correct tapped', (tester) async {
        await tester.pumpWidget(buildTestWidget(
          exerciseType: ExerciseType.multipleChoiceText,
          multipleChoiceOptions: ['Hello', 'World', 'Thanks', 'Goodbye'],
          answerState: AnswerState.answered,
    ...
    group('Writing Translation', () {
      ...
      testWidgets('should disable Check Answer when input empty', (tester) async {
        await tester.pumpWidget(buildTestWidget(
          exerciseType: ExerciseType.writingTranslation,
        ));
